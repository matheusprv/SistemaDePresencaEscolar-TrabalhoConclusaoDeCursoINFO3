                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[0])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[1])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[2])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[3])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[4])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[5])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[6])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[7])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[8])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[9])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[10])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[11])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[12])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[13])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[14])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[15])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[16])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[17])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[18])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[19])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[20])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[21])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[22])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[23])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
                                    ...
                                    <?php
                                        foreach ($vetor as $key => $val) {
                                            if($atualizar==0){
                                                ...
                                                ?>
                                                    <option value="<?php print($vetor[$key]->idDisciplina) ?>" <?php echo($vetor[$key]->idDisciplina == $exibirDisciplina[24])?"selected":"" ?>><?php print($vetor[$key]->nome) ?></option>
                                                <?php
                                            }
                                        }
                                    ?>
...
<script>
    ...
    function recuperarDadosTabela(){
        ...
        info.innerHTML = segunda1 + ' - ' + terca1 + ' - ' + quarta1 + ' - ' + quinta1+ ' - ' + sexta1 +' - '+ segunda2 + ' - ' + terca2 + ' - ' + quarta2 + ' - ' + quinta2+ ' - ' + sexta2+' - '+ segunda3 + ' - ' + terca3 + ' - ' + quarta3 + ' - ' + quinta3+ ' - ' + sexta3+' - '+ segunda4 + ' - ' + terca4 + ' - ' + quarta4 + ' - ' + quinta4+ ' - ' + sexta4+' - '+ segunda5 + ' - ' + terca5 + ' - ' + quarta5 + ' - ' + quinta5+ ' - ' + sexta5
