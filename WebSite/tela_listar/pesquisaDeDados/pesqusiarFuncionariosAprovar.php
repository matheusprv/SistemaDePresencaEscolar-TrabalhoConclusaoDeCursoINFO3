<?php
    ...
    $sql = "SELECT * FROM Funcionario WHERE verificado = 0 AND (nome like '%$pesquisa%' OR email like '%$pesquisa%')";
    ...
    if($numeroDeResultados>0){
        ...
        $sql = "SELECT * FROM Funcionario WHERE verificado = 0  AND (nome like '%$pesquisa%' OR email like '%$pesquisa%') ORDER BY Nome LIMIT " . $primeiroResultadoDaPagina. ',' . $numResultadosPorPagina;
        $funcionarios = $conn->query($sql);
