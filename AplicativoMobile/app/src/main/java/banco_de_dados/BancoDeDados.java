    ...
    public ResponsavelAluno pesquisarResponsavelLogin(String email, String senha){
        ...
        try(SQLiteDatabase db = this.getReadableDatabase()) {
            ...
            if(tuplas.moveToFirst()){
                ...
                usuario = new ResponsavelAluno(nome,emailUsuario, senhaUsuario, false, id, 0);
            }
    ...
    public ResponsavelAluno pesquisarAlunoLogin(String matricula, String senha){
        ...
        try(SQLiteDatabase db = this.getWritableDatabase()) {
            ...
            if(tuplas.moveToFirst()){
                ...
                usuario = new ResponsavelAluno(nome,matricula, senhaUsuario, true, Integer.parseInt(matricula), idTurma);
            }
        ...
        try(SQLiteDatabase db = this.getWritableDatabase()) {
            ...
            if(tuplas.moveToFirst()){
                do{
                    ...
                    ResponsavelAluno temporario = new ResponsavelAluno(nome,matricula+"", senhaUsuario, true, matricula, idTurma);
        ...
        try(SQLiteDatabase db = this.getWritableDatabase()) {
            ...
            if(tuplas.moveToFirst()){
                do{
                    ...
                    Disciplina temporario = new Disciplina(idDisciplina, nome, 0);
                    resultados.add(temporario);
